...
app.get('/places', (req, res, next) => {
  https.get('https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=40.705076,-74.00916&radius=1000&types=food&key=AIzaSyBYHwQcut25RfGMkrRKC262-ZScpb_h2xM', (places) => places.pipe(res))
  .on('error', next)
})
